...
func (c *Client) FindResUsersApikeysShow(criteria *Criteria) (*ResUsersApikeysShow, error) {
	...
	return nil, fmt.Errorf("res.users.apikeys.show was not found with criteria %v", criteria)
}
...
func (c *Client) FindResUsersApikeysShowId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("res.users.apikeys.show was not found with criteria %v and options %v", criteria, options)
}

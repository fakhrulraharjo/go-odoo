...
type SmsComposer struct {
	...
	CommentSingleRecipient     *Bool      `xmlrpc:"comment_single_recipient,omptempty"`
	...
	RecipientSingleDescription *String    `xmlrpc:"recipient_single_description,omptempty"`
	RecipientSingleNumber      *String    `xmlrpc:"recipient_single_number,omptempty"`
	RecipientSingleNumberItf   *String    `xmlrpc:"recipient_single_number_itf,omptempty"`
	RecipientSingleValid       *Bool      `xmlrpc:"recipient_single_valid,omptempty"`
	RecipientValidCount        *Int       `xmlrpc:"recipient_valid_count,omptempty"`
	...
	ResModelDescription        *String    `xmlrpc:"res_model_description,omptempty"`

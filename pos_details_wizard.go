...
func (c *Client) FindPosDetailsWizard(criteria *Criteria) (*PosDetailsWizard, error) {
	...
	return nil, fmt.Errorf("pos.details.wizard was not found with criteria %v", criteria)
}
...
func (c *Client) FindPosDetailsWizardId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("pos.details.wizard was not found with criteria %v and options %v", criteria, options)
}

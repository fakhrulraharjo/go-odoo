...
func (c *Client) FindPhoneBlacklistRemove(criteria *Criteria) (*PhoneBlacklistRemove, error) {
	...
	return nil, fmt.Errorf("phone.blacklist.remove was not found with criteria %v", criteria)
}
...
func (c *Client) FindPhoneBlacklistRemoveId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("phone.blacklist.remove was not found with criteria %v and options %v", criteria, options)
}

...
type StockPickingType struct {
	...
	AutoShowReceptionReport       *Bool      `xmlrpc:"auto_show_reception_report,omptempty"`
	...
	CreateBackorder               *Selection `xmlrpc:"create_backorder,omptempty"`
	...
	HideReservationMethod         *Bool      `xmlrpc:"hide_reservation_method,omptempty"`
	Id                            *Int       `xmlrpc:"id,omptempty"`
	Name                          *String    `xmlrpc:"name,omptempty"`
	PrintLabel                    *Bool      `xmlrpc:"print_label,omptempty"`
	ReservationDaysBefore         *Int       `xmlrpc:"reservation_days_before,omptempty"`
	ReservationDaysBeforePriority *Int       `xmlrpc:"reservation_days_before_priority,omptempty"`
	ReservationMethod             *Selection `xmlrpc:"reservation_method,omptempty"`

...
type AccountChartTemplate struct {
	...
	PropertyCashBasisBaseAccountId              *Many2One `xmlrpc:"property_cash_basis_base_account_id,omptempty"`
	...
	SpokenLanguages                             *String   `xmlrpc:"spoken_languages,omptempty"`
	...
	UseStornoAccounting                         *Bool     `xmlrpc:"use_storno_accounting,omptempty"`

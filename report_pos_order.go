...
func (c *Client) FindReportPosOrder(criteria *Criteria) (*ReportPosOrder, error) {
	...
	return nil, fmt.Errorf("report.pos.order was not found with criteria %v", criteria)
}
...
func (c *Client) FindReportPosOrderId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("report.pos.order was not found with criteria %v and options %v", criteria, options)
}

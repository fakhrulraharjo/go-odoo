...
type StockLocation struct {
	...
	ChildInternalLocationIds *Relation  `xmlrpc:"child_internal_location_ids,omptempty"`
	Comment                  *String    `xmlrpc:"comment,omptempty"`
	CompanyId                *Many2One  `xmlrpc:"company_id,omptempty"`
	CompleteName             *String    `xmlrpc:"complete_name,omptempty"`
	CreateDate               *Time      `xmlrpc:"create_date,omptempty"`
	CreateUid                *Many2One  `xmlrpc:"create_uid,omptempty"`
	CyclicInventoryFrequency *Int       `xmlrpc:"cyclic_inventory_frequency,omptempty"`
	DisplayName              *String    `xmlrpc:"display_name,omptempty"`
	ForecastWeight           *Float     `xmlrpc:"forecast_weight,omptempty"`
	Id                       *Int       `xmlrpc:"id,omptempty"`
	IncomingMoveLineIds      *Relation  `xmlrpc:"incoming_move_line_ids,omptempty"`
	LastInventoryDate        *Time      `xmlrpc:"last_inventory_date,omptempty"`
	LocationId               *Many2One  `xmlrpc:"location_id,omptempty"`
	Name                     *String    `xmlrpc:"name,omptempty"`
	NetWeight                *Float     `xmlrpc:"net_weight,omptempty"`
	NextInventoryDate        *Time      `xmlrpc:"next_inventory_date,omptempty"`
	OutgoingMoveLineIds      *Relation  `xmlrpc:"outgoing_move_line_ids,omptempty"`
	...
	ReplenishLocation        *Bool      `xmlrpc:"replenish_location,omptempty"`
	...
	WarehouseViewIds         *Relation  `xmlrpc:"warehouse_view_ids,omptempty"`

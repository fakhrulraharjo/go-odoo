...
type SnailmailConfirmInvoice struct {
	...
	InvoiceSendId *Many2One `xmlrpc:"invoice_send_id,omptempty"`
...
func (c *Client) FindSnailmailConfirmInvoice(criteria *Criteria) (*SnailmailConfirmInvoice, error) {
	...
	return nil, fmt.Errorf("snailmail.confirm.invoice was not found with criteria %v", criteria)
}
...
func (c *Client) FindSnailmailConfirmInvoiceId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("snailmail.confirm.invoice was not found with criteria %v and options %v", criteria, options)
}

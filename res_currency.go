...
type ResCurrency struct {
	...
	DisplayRoundingWarning   *Bool      `xmlrpc:"display_rounding_warning,omptempty"`
	FullName                 *String    `xmlrpc:"full_name,omptempty"`
	Id                       *Int       `xmlrpc:"id,omptempty"`
	InverseRate              *Float     `xmlrpc:"inverse_rate,omptempty"`
	IsCurrentCompanyCurrency *Bool      `xmlrpc:"is_current_company_currency,omptempty"`
	...
	RateString               *String    `xmlrpc:"rate_string,omptempty"`

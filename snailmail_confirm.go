...
func (c *Client) FindSnailmailConfirm(criteria *Criteria) (*SnailmailConfirm, error) {
	...
	return nil, fmt.Errorf("snailmail.confirm was not found with criteria %v", criteria)
}
...
func (c *Client) FindSnailmailConfirmId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("snailmail.confirm was not found with criteria %v and options %v", criteria, options)
}

...
func (c *Client) FindPosPackOperationLot(criteria *Criteria) (*PosPackOperationLot, error) {
	...
	return nil, fmt.Errorf("pos.pack.operation.lot was not found with criteria %v", criteria)
}
...
func (c *Client) FindPosPackOperationLotId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("pos.pack.operation.lot was not found with criteria %v and options %v", criteria, options)
}

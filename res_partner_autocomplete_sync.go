...
func (c *Client) FindResPartnerAutocompleteSync(criteria *Criteria) (*ResPartnerAutocompleteSync, error) {
	...
	return nil, fmt.Errorf("res.partner.autocomplete.sync was not found with criteria %v", criteria)
}
...
func (c *Client) FindResPartnerAutocompleteSyncId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("res.partner.autocomplete.sync was not found with criteria %v and options %v", criteria, options)
}

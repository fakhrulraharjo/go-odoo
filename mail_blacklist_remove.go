...
func (c *Client) FindMailBlacklistRemove(criteria *Criteria) (*MailBlacklistRemove, error) {
	...
	return nil, fmt.Errorf("mail.blacklist.remove was not found with criteria %v", criteria)
}
...
func (c *Client) FindMailBlacklistRemoveId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("mail.blacklist.remove was not found with criteria %v and options %v", criteria, options)
}

...
func (c *Client) FindMailRenderMixin(criteria *Criteria) (*MailRenderMixin, error) {
	...
	return nil, fmt.Errorf("mail.render.mixin was not found with criteria %v", criteria)
}
...
func (c *Client) FindMailRenderMixinId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("mail.render.mixin was not found with criteria %v and options %v", criteria, options)
}

...
func (c *Client) FindSequenceMixin(criteria *Criteria) (*SequenceMixin, error) {
	...
	return nil, fmt.Errorf("sequence.mixin was not found with criteria %v", criteria)
}
...
func (c *Client) FindSequenceMixinId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("sequence.mixin was not found with criteria %v and options %v", criteria, options)
}

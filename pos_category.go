...
func (c *Client) FindPosCategory(criteria *Criteria) (*PosCategory, error) {
	...
	return nil, fmt.Errorf("pos.category was not found with criteria %v", criteria)
}
...
func (c *Client) FindPosCategoryId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("pos.category was not found with criteria %v and options %v", criteria, options)
}

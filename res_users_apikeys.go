...
func (c *Client) FindResUsersApikeys(criteria *Criteria) (*ResUsersApikeys, error) {
	...
	return nil, fmt.Errorf("res.users.apikeys was not found with criteria %v", criteria)
}
...
func (c *Client) FindResUsersApikeysId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("res.users.apikeys was not found with criteria %v and options %v", criteria, options)
}

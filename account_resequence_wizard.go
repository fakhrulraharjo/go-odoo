...
type AccountResequenceWizard struct {
	...
	FirstDate           *Time      `xmlrpc:"first_date,omptempty"`
	FirstName           *String    `xmlrpc:"first_name,omptempty"`
	Id                  *Int       `xmlrpc:"id,omptempty"`
	MoveIds             *Relation  `xmlrpc:"move_ids,omptempty"`
	NewValues           *String    `xmlrpc:"new_values,omptempty"`
	Ordering            *Selection `xmlrpc:"ordering,omptempty"`
	PreviewMoves        *String    `xmlrpc:"preview_moves,omptempty"`
	SequenceNumberReset *String    `xmlrpc:"sequence_number_reset,omptempty"`
...
func (c *Client) FindAccountResequenceWizard(criteria *Criteria) (*AccountResequenceWizard, error) {
	...
	return nil, fmt.Errorf("account.resequence.wizard was not found with criteria %v", criteria)
}
...
func (c *Client) FindAccountResequenceWizardId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("account.resequence.wizard was not found with criteria %v and options %v", criteria, options)
}

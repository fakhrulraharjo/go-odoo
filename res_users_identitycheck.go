...
func (c *Client) FindResUsersIdentitycheck(criteria *Criteria) (*ResUsersIdentitycheck, error) {
	...
	return nil, fmt.Errorf("res.users.identitycheck was not found with criteria %v", criteria)
}
...
func (c *Client) FindResUsersIdentitycheckId(criteria *Criteria, options *Options) (int64, error) {
	...
	return -1, fmt.Errorf("res.users.identitycheck was not found with criteria %v and options %v", criteria, options)
}
